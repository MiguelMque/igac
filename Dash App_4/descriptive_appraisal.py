...
#Here is build the layout of the second page

def instructions():
    """
    These are the instructions to use the apliccation

    Returns a text to be seen in the sidebar of the app
    -------
    TYPE
        DESCRIPTION.
    ...
    -To calculate the massive appraisal, load the file with the following columns: Rooms, Baths, Area, Type, Address, Municipality and Department and click on the calculate button
...
#This is the layout of tab for individual calulation of the appraisal.
...
#This is the layout of tab for bulk calulation of the appraisal.
...
#This is the layout of tab for descriptive analysis.
